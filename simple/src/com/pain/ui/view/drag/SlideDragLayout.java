...
public class SlideDragLayout extends FrameLayout{
    ...
    public SlideDragLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onFinishInflate() {
        ...
        vg_main = (ViewGroup) getChildAt(isShowShadow ? 2 : 1);
//        vg_main.setSlideDragLayout(this);
